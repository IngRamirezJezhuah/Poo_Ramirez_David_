## commit "Programa 28- Clases y Objetos - Dependencia"
import time 
class Carro:
    ...
    def Donitas(self,material):
        print("esta quemando la llanta de:", material)
...
llanta = Derrapar("Aluminio")
Ferrarri.Donitas(llanta)